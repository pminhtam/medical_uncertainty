...
def parse_args():
    ...
    parser.add_argument('--checkpoint',default = "normal_branchy",required=False, help='path to checkpoint ')
    parser.add_argument('--gpu_id',type=int, default = 0, help='GPU id ')
    parser.add_argument('--resume',type=str, default = 'model_best.pt', help='Resume from checkpoint ')
